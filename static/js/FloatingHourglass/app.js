$(document).ready(function(){
    ...
    var playTexture = PIXI.Texture.fromImage('/static/imgs/FloatingHourglass/play.svg');
    var pauseTexture = PIXI.Texture.fromImage('/static/imgs/FloatingHourglass/pause.svg')
    ...
    resetButton = new PIXI.Sprite.fromImage("/static/imgs/FloatingHourglass/refresh-ccw.svg");
    ...
    runButton = new PIXI.Sprite.fromImage("/static/imgs/FloatingHourglass/run.png");
...
class Can extends PIXI.Container {
    constructor(name, x, y, width, height, color, percent = 1, mw=1, g=1, kappa=1) {
        ...
        this.name = new PIXI.Sprite.fromImage("/static/imgs/FloatingHourglass/" + name + ".png");
